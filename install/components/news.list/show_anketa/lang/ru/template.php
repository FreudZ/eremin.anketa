...
$MESS["ANKETA_INPUT_EMAIL_PLACEHOLDER"] = "email";
$MESS["ANKETA_INPUT_COMMENT_PLACEHOLDER"] = "Комментарии";
$MESS["ANKETA_BUTTON_SUBMIT_TEXT"] = "Отправить";
$MESS["ANKETA_ERROR_TEXT"] = "Пожалуйста заполните все обязательные поля и дайте ответы на все предложенные вопросы.";
?>